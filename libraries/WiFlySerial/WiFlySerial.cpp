...
#define STI_WIFLYDEVICE_SET_CHANNEL       33
#define STI_WIFLYDEVICE_SET_WIFI_AUTH     34
#define STI_WIFLYDEVICE_SET_WIFI_JOIN     35
#define STI_WIFLYDEVICE_GET_STATUS        36
#define STI_WIFLYDEVICE_GET_MAC_ADDR      37
#define STI_WIFLYDEVICE_RETURN            38
#define STI_WIFLYDEVICE_GET_IP_IND        39
#define STI_WIFLYDEVICE_GET_NM_IND        40
#define STI_WIFLYDEVICE_GET_GW_IND        41
#define STI_WIFLYDEVICE_GET_DNS_IND       42
#define STI_WIFLYDEVICE_GET_WLAN_SSID_IND 43
#define STI_WIFLYDEVICE_GET_RSSI_IND      44
#define STI_WIFLYDEVICE_GET_BATTERY_IND   45
#define STI_WIFLYDEVICE_GET_WLAN_DEV_IND  46
#define STI_WIFLYDEVICE_GET_TIME_IND      47
#define STI_WIFLYDEVICE_GET_STATUS_IND    48
#define STI_WIFLYDEVICE_GET_IP_UP_IND     49
#define STI_WIFLYDEVICE_OPEN              50
#define STI_WIFLYDEVICE_REBOOT            51
#define STI_WIFLYDEVICE_CLOSE             52
#define STI_WIFLYDEVICE_SET_LOCAL_PORT    53
#define STI_WIFLYDEVICE_SET_REMOTE_PORT   54
#define STI_WIFLYDEVICE_SET_PROTOCOL      55
#define STI_WIFLYDEVICE_SAVE              56
...
//  DebugPrint("WiFlySerial::begin\n");
    ...
    if (strlen(szWiFlyPrompt) < 1 )
    {
        ...
        waitAndYield(WIFLY_RESTART_WAIT_TIME);
        // try again
...
boolean WiFlySerial::StartCommandMode(char* pBuffer, const int bufSize)
{
    ...
    while  (!bWiFlyInCommandMode || bWaiting )
    {
        ...
        if ( !bWiFlyInCommandMode)
        {
            ...
            waitAndYield(COMMAND_MODE_GUARD_TIME );
                                  ...
                                  const boolean bCollecting, const  unsigned long iWaitTime, const boolean bClear, const boolean bPromptAfterResult)
{
    ...
    return ((iResponse & PROMPT_EXPECTED_TOKEN_FOUND) == PROMPT_EXPECTED_TOKEN_FOUND);
}
...
boolean WiFlySerial::leave()
{
    ...
    return SendCommand(GetBuffer_P(STI_WIFLYDEVICE_LEAVE, szCmd, COMMAND_BUFFER_SIZE),
...
void WiFlySerial::setWaitCallback(void (*function)())
{
    waitCallback = function;
}

void WiFlySerial::waitAndYield(unsigned long ms)
{
