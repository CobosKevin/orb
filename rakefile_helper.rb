require 'yaml'
require 'fileutils'
require HERE+'vendor/unity/auto/unity_test_summary'
require HERE+'vendor/unity/auto/generate_test_runner'
require HERE+'vendor/unity/auto/colour_reporter'
...
module RakefileHelpers
  ...
  def configure_toolchain(config_file=DEFAULT_CONFIG_FILE)
    ...
    load_configuration(HERE+"targets/#{config_file}")
    configure_clean
  end
  ...
  def find_source_file(header, paths)
    paths.each do |dir|
      ...
      return src_file if (File.exists?(src_file))
      src_file = dir + header.ext(CPP_EXTENSION)
      return src_file if (File.exists?(src_file))
    end
    return nil
  end
  ...
  def run_tests(test_files)
    ...
    test_files.each do |test|
      ...
      header_list.each do |header|
        ...
        if (header =~ /Mock/) 
          require HERE+"vendor/cmock/auto/cmock.rb" 
